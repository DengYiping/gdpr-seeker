    ...
    <HydrateClient>
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#0b132b] to-[#1c2541] text-white">
        <div className="container mx-auto flex max-w-5xl flex-col items-center justify-center gap-10 px-6 py-20">
          ...
          >
            <div className="rounded-xl bg-white/5 p-6">
              ...
              <p className="mt-2 text-white/80">
                ...
                obtain your personal data collected during the interview
                process.
              </p>
            ...
            <div className="rounded-xl bg-white/5 p-6">
              ...
              <p className="mt-2 text-white/80">
                Request deletion of your personal data from company systems
          ...
          <section
            id="how-it-works"
            className="w-full rounded-xl bg-white/5 p-6"
          >
          ...
          <section id="faq" className="w-full">
            ...
            <p className="mt-2 text-white/80">
              Many recruiters decline to provide feedback after interviews.
              Under GDPR, you have rights to access your data and understand
              automated decisions. GDPR Seeker streamlines exercising those
              rights and increases your chances of receiving actionable
              feedback.
            </p>
          </section>
